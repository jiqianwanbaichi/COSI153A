...
const APIdemo = () => {
    ...
    const [prompt, setPrompt] = useState("what is the main conent of movie the titanic?");
    ...
    return (
        <SafeAreaView style={{ flex: 1, fontSize: 24, margin: 30 }}>
            <Text>ChatMovie</Text>
            <Text style={{ marginTop: 30 }}>Introduction of a movie? </Text>
            <TextInput
            ...
            <Button
                onPress={() => { setLoading(true); setData({ choices: [] }); setPrompt('please introduce the movie whose name is: ' + promptText); }}
